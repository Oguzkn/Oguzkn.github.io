...
window.anlık_veri_görselleştirme=function(prm_rtdbden_yakalan_veriler){// trigger sonrası okunan verilere göre oyun tahtası görüntüsünü düzenliyor görseli düzenliyor
  ...
  if(prm_rtdbden_yakalan_veriler.Gender_1 !=''){// bu satırın amacı oyun ekranı ilk defa yüklendiğinde varsayılan olarak boş gelen Gender_1 verisinin konsole hata mesajı verdirmemesini sağlamak.Dolana kadar bloğu çalıştırmıyor.
    ...
    ses_çalar();
    if(cins_1[0][0]=="s"){border_effect("hamle_sırası_beyazda")}
    if(cins_1[0][0]=="b"){border_effect("hamle_sırası_siyahta")}
...
var sn=0;var dk=0;var sayac_nesnesi;
...
window.border_effect=function(prm_hamle_sırası_kimde){
  if(prm_hamle_sırası_kimde =="hamle_sırası_beyazda"){
    document.querySelector(".div_gamer_name.d1").style.border="5px solid #000";
    document.querySelector(".div_gamer_name.d2").style.border="3px solid #999";
  }
  if(prm_hamle_sırası_kimde =="hamle_sırası_siyahta"){
    document.querySelector(".div_gamer_name.d2").style.border="5px solid #000";
    document.querySelector(".div_gamer_name.d1").style.border="3px solid #999";
  }
